...
class Auth2 with ChangeNotifier {
  ...
  Future<void> signup(String email, String password) async {
    Uri url = Uri.parse(
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAJDrOF1lGIYbBkqpkVNGs4M7QoTujFRLA");
  ...
  Future<void> login(String email, String password) async {
    Uri url = Uri.parse(
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAJDrOF1lGIYbBkqpkVNGs4M7QoTujFRLA");
